...
prop(wine_41, fixed_acidity, 8.3).
...
prop(wine_41, volatile_acidity, 0.14).
...
prop(wine_41, residual_sugar, 1.10).
...
prop(wine_41, free_sulfur_dioxide, 7.0).
...
prop(wine_41, total_sulfur_dioxide, 47.0).
